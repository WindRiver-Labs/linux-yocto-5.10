...
#define RIO_LRC32(a, b, c) __rio_local_read_config_32((a), (b), (c))
#define RIO_LWC32(a, b, c) __rio_local_write_config_32((a), (b), (c))
...
#define  EPC_PNADIDCSR_ADE	BIT(31)
...
#define RAB_INT_OB_DB_EN        BIT(31)
#define EXT_INT_OB_DB_EN        (0xff << 16)
#define MISC_INT_EN             BIT(6)
#define OB_DME_INT_EN           BIT(5)
#define IB_DME_INT_EN           BIT(4)
#define RPIO_INT_EN             BIT(1)
#define APIO_INT_EN             (1)

#define RAB_INTR_ENAB_GNRL_SET  (MISC_INT_EN | RPIO_INT_EN | APIO_INT_EN)

#define RAB_INTR_STAT_GNRL      (RAB_REG_BASE + 0x60)
/* General int status bits */
#define RAB_INTERNAL_STAT       BIT(31)
#define EXT_INT_STATUS          (0xff << 16)
#define MISC_INT                BIT(6)
#define OB_DME_INT              BIT(5)
#define IB_DME_INT              BIT(4)
#define RPIO_INT                BIT(1)
#define APIO_INT                (1)
...
/* PIO int status bits */
#define APIO_TRANS_FAILED       BIT(8)
...
#define RPIO_TRANS_FAILED       BIT(8)
...
#define USR_INT                 BIT(16)
#define AMST_INT                BIT(11)
#define ASLV_INT                BIT(10)
#define LFC_INT                 BIT(9)
#define CO_LOCK_INT             BIT(8)
#define LINK_REQ_INT            BIT(7)
#define LL_TL_INT               BIT(6)
#define GRIO_INT                BIT(5)
#define PORT_WRITE_INT          BIT(4)
#define UNSP_RIO_REQ_INT        BIT(3)
#define UNEXP_MSG_INT           BIT(2)
#define OB_DB_DONE_INT          BIT(1)
...
#define OB_DME_STAT_SLEEPING             BIT(9)
#define OB_DME_STAT_TRANS_PEND           BIT(8)
#define OB_DME_STAT_RESP_TO              BIT(7)
#define OB_DME_STAT_RESP_ERR             BIT(6)
#define OB_DME_STAT_DATA_TRANS_ERR       BIT(5)
#define OB_DME_STAT_DESC_UPD_ERR         BIT(4)
#define OB_DME_STAT_DESC_ERR             BIT(3)
#define OB_DME_STAT_DESC_FETCH_ERR       BIT(2)
#define OB_DME_STAT_DESC_XFER_CPLT       BIT(1)
...
#define IB_DME_STAT_SLEEPING             BIT(9)
#define IB_DME_STAT_TRANS_PEND           BIT(8)
#define IB_DME_STAT_MSG_TIMEOUT          BIT(7)
#define IB_DME_STAT_MSG_ERR              BIT(6)
#define IB_DME_STAT_DATA_TRANS_ERR       BIT(5)
#define IB_DME_STAT_DESC_UPDATE_ERR      BIT(4)
#define IB_DME_STAT_DESC_ERR             BIT(3)
#define IB_DME_STAT_DESC_FETCH_ERR       BIT(2)
#define IB_DME_STAT_DESC_XFER_CPLT       BIT(1)
...
#define DME_DESC_DW0_RIO_ERR            BIT(11)
#define DME_DESC_DW0_AXI_ERR            BIT(10)
#define DME_DESC_DW0_TIMEOUT_ERR        BIT(9)
#define DME_DESC_DW0_DONE               BIT(8)
#define DME_DESC_DW0_SZ_MASK            BIT(4)
#define DME_DESC_DW0_EN_INT             BIT(3)
#define DME_DESC_DW0_END_OF_CHAIN       BIT(2)
...
/* Round up and shift to make double word */
#define DME_DESC_DW1_MSGLEN(s)          (((((s) + 7) & ~7) >> 3) << 8)
...
struct rio_priv {
	...
	struct mutex api_lock;	/* SRIO API Lock */
...
int alcr(struct rio_priv *priv, u32 offset, u32 *data);
int alcw(struct rio_priv *priv, u32 offset, u32 data);
