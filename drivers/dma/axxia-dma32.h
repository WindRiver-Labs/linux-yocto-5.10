...
#define    DMA_SRC_ACCESS_BURST_TYPE		BIT(15)
...
#define GEN_STAT       0x0
#define   GEN_STAT_CH0_ACTIVE BIT(0)
#define   GEN_STAT_CH1_ACTIVE BIT(2)
#define   GEN_STAT_CH1_ACTIVE BIT(2)
#define   GEN_STAT_CH0_ERROR  BIT(16)
#define   GEN_STAT_CH1_ERROR  BIT(17)
#define GEN_CONFIG     0x4
#define  GEN_CONFIG_EXT_MEM                     BIT(19)
#define  GEN_CONFIG_INT_EDGE(_ch)               BIT(_ch)
...
struct axxiadma_hw {
	...
	unsigned int flags;
#define AXXIADMA_NEXT_FULL     BIT(0)
#define AXXIADMA_SEG_REGS      BIT(1)
#define AXXIADMA_EDGE_INT      BIT(2)
};
