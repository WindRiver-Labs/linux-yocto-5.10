...
/*
 * @Function	ra_request_alloc_fail
 * @Description
 * Default callback allocator used if no callback is specified, always fails
 * to allocate further resources to the arena.
 *
 * @Input	import_hdnl : Callback handle.
 * @Input	requested_size : Requested allocation size.
 * @Input	ref : Pointer to user reference data.
 * @Input	alloc_flags : Allocation flags.
 * @Output	actual_size : Pointer to contain the actual allocated size.
 * @Output	base_addr : Allocation base(always 0,it is failing).
