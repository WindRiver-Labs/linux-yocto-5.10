...
/*
 * @Function	talmmu_devmem_heap_empty
 *
 * @Description	This function is used for emptying the device memory heap list
 *
 * @Input	devmem_ctx_hndl: device memory context handle
 *
 * @Input	devmem_heap_hndl: device memory heap handle
 *
