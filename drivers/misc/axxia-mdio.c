...
#define   CONTROL_BUSY		BIT(31) /* MDIO cycle in progress (RO) */
#define   CONTROL_NOPRE		BIT(30) /* Suppress preamble */
#define   CONTROL_CL22		(0 << 29) /* Clause-22 */
#define   CONTROL_CL45		BIT(29) /* Clause-45 */
#define   CONTROL_READ		(2 << 27) /* Read operation */
#define   CONTROL_WRITE		BIT(27) /* Write operation */
#define   CONTROL_IFSEL		BIT(26) /* Interface select */
...
static const struct of_device_id axxia_mdio_match[] = {
