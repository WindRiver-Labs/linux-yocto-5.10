...
#define    PRESENT_GMAC0		BIT(0)
#define    PRESENT_GMAC0_PFC		BIT(16)
#define NEM_INT_STATUS_R		0x0010
#define NEM_INT_ENABLE_R		0x0014
#define NEM_INT_FORCE_R			0x0018
#define    INT_GROUP_GMAC0		BIT(0)
#define    INT_GROUP_STATS		BIT(14)
#define    INT_GROUP_PTI		BIT(15)
#define NEM_SWRESET_R			0x0020
#define    SWRESET_GMAC0		BIT(0)
#define    SWRESET_STATS		BIT(14)
#define    SWRESET_PTI			BIT(15)
#define NEM_ACTIVE_R			0x0024
#define    ACTIVE_GMAC0			BIT(0)
#define NEM_LOS_CONTROL_R		0x0028
#define    FILTER_ENABLE		BIT(0)
#define    DEBUG_SEL(_x)		(((_x) & 0xf) << 12)	 /* 0..15 */
#define    FILTER_TOV(_x)		(((_x) & 0xffff) << 16)	 /* 0..65535 */
#define NEM_LOS_DEBUG_R			0x002c
#define    LOS_RAW			BIT(0)
...
#define    PTI_GMAC0			BIT(0)
#define NEM_PTI_CONFIG_R		0x0118
#define    GMAC_RX_TS_ENABLE(_x)	(((_x) & 0xfff) << 0)	 /* 0..4095 */
#define    XGMAC_RX_TS_ENABLE		BIT(12)
#define    TX_TS_COR			BIT(13)
#define    TS_OUT_FORMAT(_x)		(((_x) & 0x3) << 14)	 /* 0..3 */
#define    PTI_MAC_LOOPBACK		BIT(16)
#define    TS_MODE			BIT(17)
...
#define    TX_FIFO_UNDERFLOW		BIT(0)
#define    TX_FIFO_OVERFLOW		BIT(1)
#define    TX_FIFO_EMPTY		BIT(2)
#define    TX_FIFO_AEMPTY		BIT(3)
#define    TX_FIFO_AFULL		BIT(4)
...
#define    RX_FIFO_UNDERFLOW		BIT(0)
#define    RX_FIFO_OVERFLOW		BIT(1)
#define    RX_FIFO_EMPTY		BIT(2)
#define    RX_FIFO_AEMPTY		BIT(3)
#define    RX_FIFO_AFULL		BIT(4)
#define    RX_FIFO_FULL			BIT(5)
...
#define    RGMII_SWAP_TX		BIT(9)
#define    RGMII_SWAP_RX		BIT(8)
#define    RGMII_MODE			BIT(7)
#define    GPIO_CLK_MUX_SELECT		BIT(6)
#define    GMAC_TX_INIT_PAUSE		BIT(5)
#define    GMII_BYPASS_MODE		BIT(4)
#define    GMAC_RX_EN			BIT(3)
#define    PORT_ENABLE			BIT(2)
#define    GMAC_RX_PAUSE_EN		BIT(1)
#define    GMAC_TX_PAUSE_EN		BIT(0)
#define NEM_GMAC_STA_ADDR_R		0x0304
#define NEM_GMAC_STA_ADDR_UPPER_R	0x0308
#define NEM_GMAC_TIMING_CTRL_R		0x030c
#define    LOOPBACK_IFG_MODE		BIT(6)
#define    SEL_EXT_PAUSE_WAIT_IN	BIT(5)
#define    INFINITE_RETRY		BIT(4)
#define    ZERO_BACKOFF			BIT(3)
#define    FAST_SLOT_TMR_MODE		BIT(2)
#define    FIXED_MODE			BIT(1)
#define    SHORT_IFG_MODE		BIT(0)
#define NEM_GMAC_MAC_CTRL_R		0x0310
#define    WOL_ENABLE			BIT(10)
#define    TX_PAD_ENABLE		BIT(6)
#define    RX_CRC_STRIP_ENABLE		BIT(5)
#define    RX_ABORT_DISABLE		BIT(4)
#define    GMAC_TX_FLUSH		BIT(2)
#define    AUTO_FLUSH_MODE		BIT(1)
#define    GM_DEBUG_SELECT		BIT(0)
#define NEM_GMAC_MAC_STATUS_R		0x0314
#define    GM_DEBUG(_x)			(((_x) & 0x3ff) << 3)	 /* 0..1023 */
#define    L_FIFO_OVERRUN		BIT(2)
#define    L_ANY_FIFO_UNDERRUN		BIT(1)
#define    TX_ENCAP_DONE		BIT(0)
#define NEM_GMAC_PRBS_ERR_R		0x0318
#define    C6_PRBS_ERR(_x)		(((_x) & 0xff) << 0)	 /* 0..255 */
#define NEM_GMAC_SGMII_ENABLE_R		0x031c
#define    SGMII_C73_INT_DISABLE	BIT(2)
#define    SGMII_C37_INT_DISABLE	BIT(1)
#define    SGMII_PORT_EN		BIT(0)
#define NEM_GMAC_PRBS_CTRL_R		0x0320
#define    CLK_625_PATTERN_55		BIT(26)
#define    CLK_625_PATTERN_AA		BIT(25)
#define    LOOP_BACK			BIT(24)
#define    RESET_PRBS_COUNTER		BIT(23)
#define    INV_COMPARE			BIT(22)
#define    LOAD_SEED			BIT(21)
#define    PRBS_SEED(_x)		(((_x) & 0x3ff) << 11)	 /* 0..1023 */
#define    PRBS_DATA(_x)		(((_x) & 0x3ff) << 1)	 /* 0..1023 */
#define    PRBS_ENABLE			BIT(0)
#define NEM_GMAC_ANEG_CTRL_R		0x0324
#define    SGMII_CLOCK_RATE		BIT(13)
#define    IGNORE_AN_SYNC_STATUS	BIT(12)
#define    IGNORE_RUDI_INVALID		BIT(11)
#define    FIBER_MODE			BIT(10)
#define    SGMII_GMAC_RX_PAUSE_EN	BIT(9)
#define    SGMII_GMAC_FLOW_CONTROL_INITIATE_EN			BIT(8)
#define    AUTONEG_OFFLINE_ADVERTISE	BIT(7)
#define    AUTONEG_SPEED_UP		BIT(6)
#define    SPEED_MODE_FORCE(_x)		(((_x) & 0x3) << 4)	 /* 0..3 */
#define    GOOD_LINK_FORCE		BIT(3)
#define    FULL_DUPLEX_FORCE		BIT(2)
#define    MR_AUTONEG_ENABLE		BIT(1)
#define    RESTART_AUTONEG		BIT(0)
#define NEM_GMAC_ANEG_STATUS_R		0x0328
#define    WOL				BIT(13)
#define    C10_GMII_SPEED_MODE(_x)	(((_x) & 0x3) << 11)	 /* 0..3 */
#define    C10_GMII_FULL_DUPLEX		BIT(10)
#define    GMII_LINK_OK			BIT(9)
#define    AUTONEG_TX_PAUSE_EN		BIT(8)
#define    AUTONEG_RX_PAUSE_EN		BIT(7)
#define    REMOTE_FAULT(_x)		(((_x) & 0x3) << 5)	 /* 0..3 */
#define    REMOTE_PAUSE(_x)		(((_x) & 0x3) << 3)	 /* 0..3 */
#define    REMOTE_HD_FD(_x)		(((_x) & 0x3) << 1)	 /* 0..3 */
#define    MR_AN_COMPLETE		BIT(0)
#define NEM_GMAC_SGMII_STATUS_R		0x032c
#define    SGMII_FULL_DUPLEX		BIT(13)
#define    SGMII_SPEED_MODE(_x)		(((_x) & 0x3) << 11)	 /* 0..3 */
#define    SGMII_LINK			BIT(10)
#define    SYNC_STATUS			BIT(9)
#define    RX_DV			BIT(8)
#define    C11_PRBS_ERR			BIT(7)
#define    CURRENT_AUTONEG_STATE(_x)	(((_x) & 0x7) << 4)	 /* 0..7 */
#define    C11_GMII_FULL_DUPLEX		BIT(3)
#define    C11_GMII_SPEED_MODE(_x)	(((_x) & 0x3) << 1)	 /* 0..3 */
#define    GMII_LINK			BIT(0)
#define NEM_GMAC_FILTER_CTRL_R		0x0330
#define    ENABLE_BLANKET_FILTERING	BIT(7)
#define    ENABLE_UNICAST_SA_FILTERING	BIT(6)
#define    ENABLE_RUNT_FILTERING	BIT(5)
#define    ENABLE_PAUSE_FILTERING	BIT(4)
#define    ENABLE_UNICAST_FILTERING	BIT(3)
#define    ENABLE_MULTICAST_FILTERING	BIT(2)
#define    ENABLE_BROADCAST_FILTERING	BIT(1)
#define    PACKET_FILTERING_ENABLE	BIT(0)
...
#define    GMII_FULL_DUPLEX_MASK	BIT(10)
#define    GMII_LINK_OK_MASK		BIT(9)
#define    AUTONEG_TX_PAUSE_EN_MASK	BIT(8)
#define    AUTONEG_RX_PAUSE_EN_MASK	BIT(7)
#define    REMOTE_FAULT_MASK(_x)	(((_x) & 0x3) << 5)	 /* 0..3 */
#define    REMOTE_PAUSE_MASK(_x)	(((_x) & 0x3) << 3)	 /* 0..3 */
#define    REMOTE_HD_FD_MASK(_x)	(((_x) & 0x3) << 1)	 /* 0..3 */
#define    MR_AN_COMPLETE_MASK		BIT(0)
#define NEM_GMAC_C73_ANEG_STATUS_R	0x0368
#define    LINK_STATUS_10GKR_CHANGE	BIT(18)
#define    LINK_STATUS_10GKR		BIT(17)
#define    LOSS_OF_SIGNAL_CHANGED	BIT(16)
#define    AN_COMPLETE_CHANGED		BIT(15)
#define    LINK_STATUS_10GKX4_CHANGE	BIT(14)
#define    LINK_STATUS_1GKX_CHANGE	BIT(13)
#define    AN_RESTART_FAULT		BIT(12)
#define    AN_LINK_OK			BIT(11)
#define    LOSS_OF_SIGNAL		BIT(10)
#define    NONCE_FAILURE		BIT(9)
#define    PARALLEL_DETECTION_FAULT	BIT(8)
#define    PARALLEL_DETECTION_COMPLETE	BIT(7)
#define    PAGE_RECEIVED		BIT(6)
#define    AN_COMPLETE			BIT(5)
#define    C26_REMOTE_FAULT		BIT(4)
#define    AN_ABILITY			BIT(3)
#define    LINK_STATUS_10GKX4		BIT(2)
#define    LINK_STATUS_1GKX		BIT(1)
#define    LP_AN_ABILITY		BIT(0)
#define NEM_GMAC_C73_ANEG_INT_MASK_R	0x038c
#define    LINK_STATUS_10GKR_CHANGE_MASK	BIT(18)
#define    LINK_STATUS_10GKR_MASK	BIT(17)
#define    LOSS_OF_SIGNAL_CHANGED_MASK	BIT(16)
#define    AN_COMPLETE_CHANGED_MASK	BIT(15)
#define    LINK_STATUS_10GKX4_CHANGE_MASK	BIT(14)
#define    LINK_STATUS_1GKX_CHANGE_MASK	BIT(13)
#define    AN_RESTART_FAULT_MASK	BIT(12)
#define    AN_LINK_OK_MASK		BIT(11)
#define    LOSS_OF_SIGNAL_MASK		BIT(10)
#define    NONCE_FAILURE_MASK		BIT(9)
#define    PARALLEL_DETECTION_FAULT_MASK	BIT(8)
#define    PARALLEL_DETECTION_COMPLETE_MASK	BIT(7)
#define    PAGE_RECEIVED_MASK		BIT(6)
#define    AN_COMPLETE_MASK		BIT(5)
#define    C35_REMOTE_FAULT_MASK	BIT(4)
#define    AN_ABILITY_MASK		BIT(3)
#define    LINK_STATUS_10GKX4_MASK	BIT(2)
#define    LINK_STATUS_1GKX_MASK	BIT(1)
#define    LP_AN_ABILITY_MASK		BIT(0)
...
#define    STATS_INT_SNAPSHOT_RDY	1
#define NEM_STATS_CONFIG_R		0x0d0c
#define    STATS_MAC_RAW		BIT(15)
#define    COR				BIT(14)
...
#define   DMACTL_RST		     BIT(31)
#define   DMACTL_RX_DISABLE_PREALIGN BIT(19)
#define   DMACTL_TX_DISABLE_PREALIGN BIT(18)
#define   DMACTL_TX_FORCE_ORDERING   BIT(17)
#define   DMACTL_EN		     BIT(16)
#define   DMACTL_ALLOW_TX_PAUSE	     BIT(15)
#define   DMACTL_RX_FORCE_ORDERING   BIT(14)
#define   DMACTL_TX_TAIL_PTR_EN	     BIT(13)
#define   DMACTL_RX_TAIL_PTR_EN	     BIT(12)
...
#define   RXDMA_EN		     BIT(17)
#define   TXDMA_EN		     BIT(16)
...
#define   MISCCTL_RGMII_1000	     0
#define   MISCCTL_RGMII_100	     BIT(0)
#define   MISCCTL_RGMII_10	         BIT(1)
...
#define   INTE_RX_DONE		     BIT(9)
#define   INTE_TX_DONE		     BIT(8)
#define   INTE_ERR_MASK		     0x7f
#define   INTE_RXDMA_WERR	     BIT(6)
#define   INTE_RXDMA_FIFO_ERR	     BIT(5)
#define   INTE_RXDESC_RERR	     BIT(4)
#define   INTE_TXDMA_RERR	     BIT(3)
#define   INTE_TXDMA_WERR	     BIT(2)
#define   INTE_TXDMA_FIFO_ERR	     BIT(1)
#define   INTE_TXDESC_RERR	     BIT(0)
...
#define NEMAC_REGISTER_NAMES {						\
		...
		{ "NEM_PTI_TX_UNDERRUN_STATUS_R",                       \
				NEM_PTI_TX_UNDERRUN_STATUS_R },		\
		{ "NEM_PTI_TX_OVERRUN_STATUS_R",                        \
				NEM_PTI_TX_OVERRUN_STATUS_R },		\
		{ "NEM_PTI_RX_OVERRUN_STATUS_R",                        \
				NEM_PTI_RX_OVERRUN_STATUS_R },		\
		{ "NEM_PTI_CONFIG_R", NEM_PTI_CONFIG_R },		\
		{ "NEM_PTI_BURST_LENGTH_R", NEM_PTI_BURST_LENGTH_R },	\
		{ "NEM_PTI_GMAC_TX_HIGH_WM_R",                          \
				NEM_PTI_GMAC_TX_HIGH_WM_R },		\
		{ "NEM_PTI_GMAC_TX_LOW_WM_R",                           \
				NEM_PTI_GMAC_TX_LOW_WM_R },		\
		{ "NEM_PTI_GMAC_RX_HIGH_WM_R",                          \
				NEM_PTI_GMAC_RX_HIGH_WM_R },		\
		{ "NEM_PTI_GMAC_RX_LOW_WM_R",                           \
				NEM_PTI_GMAC_RX_LOW_WM_R },		\
		...
		{ "NEM_GMAC_UNICAST12_UPPER_R",                         \
				NEM_GMAC_UNICAST12_UPPER_R },		\
		{ "NEM_GMAC_UNICAST3_R", NEM_GMAC_UNICAST3_R },		\
		{ "NEM_GMAC_UNICAST3_UPPER_R",                          \
				NEM_GMAC_UNICAST3_UPPER_R },		\
		{ "NEM_GMAC_C37_ANEG_INT_MASK_R",                       \
				NEM_GMAC_C37_ANEG_INT_MASK_R },		\
		{ "NEM_GMAC_C73_ANEG_STATUS_R",                         \
				NEM_GMAC_C73_ANEG_STATUS_R },		\
		{ "NEM_GMAC_C73_ANEG_INT_MASK_R",                       \
				NEM_GMAC_C73_ANEG_INT_MASK_R },		\
		{ "NEM_GMAC_UCAST_MASK_LOWER_R",                        \
				NEM_GMAC_UCAST_MASK_LOWER_R },		\
		{ "NEM_GMAC_UCAST_MASK_UPPER_R",                        \
				NEM_GMAC_UCAST_MASK_UPPER_R },		\
