...
#define     NSP_CLKEN                                (0x00001400)
#define     NCP_SYSCON_ENABLE_CLKEN_SET                         (0x00001404)
#define     NSP_ACINACTM                             (0x00001408)
#define     NSP_CHIPSELECTEN                         (0x0000140c)
#define     NSP_CSYSREQ_TS                           (0x00001410)
#define     NSP_CSYSREQ_CNT                          (0x00001414)
#define     NSP_CSYSREQ_ATB                          (0x00001418)
#define     NSP_CSYSREQ_APB                          (0x0000141c)
#define     NSP_PWRUPL2LGCSTG1                       (0x00001420)
#define     NSP_PWRUPL2LGCSTG2                       (0x00001424)
#define     NSP_PWRUPL2HSRAM                         (0x00001428)
#define     NSP_ACEPWRDNRQ                           (0x0000142c)
#define     NSP_ISOLATEL2MISC                        (0x00001430)
#define     NSP_NPWRUPL2LGCSTG1_ACK                  (0x00001438)
#define     NSP_NPWRUPL2HSRAM_ACK                    (0x0000143c)
#define     NSP_STANDBYWFIL2                         (0x00001440)
#define     NSP_CSYSACK_TS                           (0x00001444)
#define     NSP_CACTIVE_TS                           (0x00001448)
#define     NSP_CSYSACK_CNT                          (0x0000144c)
#define     NSP_CACTIVE_CNT                          (0x00001450)
#define     NSP_CSYSACK_ATB                          (0x00001454)
#define     NSP_CACTIVE_ATB                          (0x00001458)
#define     NSP_CSYSACK_APB                          (0x0000145c)
#define     NSP_CACTIVE_APB                          (0x00001460)
#define     NSP_NACEPWRDNACK                         (0x00001464)
#define     NSP_CACTIVEM_EAGM                        (0x00001468)
#define     NSP_CACTIVEM_EAGS                        (0x0000146c)
#define     NSP_CACTIVES_EAGM                        (0x00001470)
#define     NSP_CACTIVES_EAGS                        (0x00001474)
#define     NSP_PWRUPCPUSTG1                         (0x00001480)
#define     NSP_PWRUPCPUSTG2                         (0x00001484)
#define     NSP_PWRUPCPURAM                          (0x00001488)
#define     NSP_ISOLATECPU                           (0x0000148c)
#define     NSP_NPWRUPCPUSTG1_ACK                    (0x00001490)
#define     NSP_NPWRUPCPURAM_ACK                     (0x00001494)
#define     NSP_QACTIVE                              (0x00001498)
#define     NSP_STANDBYWFI                           (0x0000149c)
#define     NSP_STANDBYWFE                           (0x000014a0)
#define     NSP_DBGNOPWRDWN                          (0x000014a4)
#define     NSP_DBGPWRUPREQ                          (0x000014a8)
#define     NSP_PWRUPL20RAM_PWRUPL2RAM2              (0x00001580)
#define     NSP_PWRUPL20RAM_PWRUPL2RAM1              (0x00001584)
#define     NSP_PWRUPL20RAM_PWRUPL2RAM0              (0x00001588)
#define     NSP_PWRUPL21RAM_PWRUPL2RAM2              (0x0000158c)
#define     NSP_PWRUPL21RAM_PWRUPL2RAM1              (0x00001590)
#define     NSP_PWRUPL21RAM_PWRUPL2RAM0              (0x00001594)
#define     NSP_PWRUPL22RAM_PWRUPL2RAM2              (0x00001598)
#define     NSP_PWRUPL22RAM_PWRUPL2RAM1              (0x0000159c)
#define     NSP_PWRUPL22RAM_PWRUPL2RAM0              (0x000015a0)
#define     NSP_PWRUPL23RAM_PWRUPL2RAM2              (0x000015a4)
#define     NSP_PWRUPL23RAM_PWRUPL2RAM1              (0x000015a8)
#define     NSP_PWRUPL23RAM_PWRUPL2RAM0              (0x000015ac)
...
int pm_cpu_logical_die(struct pm_data *pm_request);
int pm_cpul2_logical_die(struct pm_data *pm_request);
