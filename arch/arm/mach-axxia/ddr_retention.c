...
reset_elm_trace(void)
{
	...
	ncr_register_write(htonl(0x000fff04), (unsigned int *)(apb + 0x68000));
	ncr_register_write(htonl(0x000fff04), (unsigned int *)(apb + 0x78000));

	/* reset ELM statistics */
	ncr_register_write(htonl(0x00001), (unsigned int *)(apb + 0x60230));
	ncr_register_write(htonl(0x00001), (unsigned int *)(apb + 0x70230));

	/* enable ELM trace */
	ncr_register_write(htonl(0x000fff01), (unsigned int *)(apb + 0x68000));
	ncr_register_write(htonl(0x000fff01), (unsigned int *)(apb + 0x78000));
}
...
initiate_retention_reset(void)
{
	...
	flush_tlb_ID();
	ncr_register_write(htonl(value), (unsigned int *)(apb + 0x31030));
