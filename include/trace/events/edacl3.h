...
TRACE_EVENT(edacl3_error_types,
	...
	TP_STRUCT__entry(__field(u64, error_31_0)
		__field(u64, error_63_32)
		__field(u64, error_95_64)
		__field(u64, error_159_128)
	),

	TP_fast_assign(__entry->error_31_0 = error_31_0;
...
TRACE_EVENT(edacl3_sig_vals,
	...
	TP_STRUCT__entry(__field(u64, sig_val_63_0)
		__field(u64, sig_val_127_64)
		__field(u64, sig_val_191_128)
	),

	TP_fast_assign(__entry->sig_val_63_0 = sig_val_63_0;
...
TRACE_EVENT(edacl3_syndromes,
	...
	TP_STRUCT__entry(__field(u64, syndrome0)
		__field(u64, syndrome1)
	),

	TP_fast_assign(__entry->syndrome0 = syndrome0;
...
TRACE_EVENT(edacl3_smc_results,
	...
	TP_STRUCT__entry(__field(u64, a0)
		__field(u64, a1)
		__field(u64, a2)
		__field(u64, a3)
	),

	TP_fast_assign(__entry->a0 = ptr->a0;
		__entry->a1 = ptr->a1;
		__entry->a2 = ptr->a2;
		__entry->a3 = ptr->a3;
	),
